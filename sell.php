...
<hr />
<p class="text-center"style="font-size:2.5vw">Fill details to schedule pickup</p>
<div style="margin:5%;border-radius: 5px;background-color: #f2f2f2;padding: 20px; ">
  <form id="sell" action="sellaction.php" method="post">
    <label>Name</label>
    ...
    <input type="text" id="Hno" name="Hno" placeholder="House no.">
	...
	<select id="exchange" name="exchange">
		<option selected disabled value>What do you want in exchange of scrap</option>
