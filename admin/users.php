...
{  $j=1;
    ...
    {	
       ...
       echo "<td><a href=\"editusers.php?id=".$_SESSION['id']."\"><input type='button' value='Edit' 
		class='btn btn-primary'></a> <a onClick=\"javascript: return confirm('Please confirm deletion');\" href='deleteusersaction.php?id=".$_SESSION['id']."'><input type='button' value='Delete' class='btn btn-primary'></a></td></tr>";
       echo "</form>";
       $j++;
    }
}
