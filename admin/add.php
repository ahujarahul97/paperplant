        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                        ...
                        <div class="form-three widget-shadow">
                            <form action="addplan.php" method="POST" class="form-horizontal">
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Plan's Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" id="focusedinput" name="planname" placeholder="Name of Plan">
                                    </div>
                                    <!-- <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control1" id="focusedinput" name="cost" placeholder="Enter a number only">
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="txtarea1" class="col-sm-2 control-label">Description</label>
                                    <div class="col-sm-8"><textarea id="txtarea1" name="description" cols="96" rows="10" class=""></textarea></div>
                                </div>
                                <div class="form-group">
